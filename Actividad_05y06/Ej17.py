...
from Class_Vertices_17 import *
from Class_Grafos_17 import *
...
def main(): #definimos el programa principal
    ...
    try:
        ...
        if (vertice not in vertices_posibles):
            ...
            print("\nComo podemos comprobar el algoritmo prim es O(n^2), ya que este contiene dos bucles for anidados, uno para buscar la conexion mas corta y otro para añadir las aristas") #imprimimos una explicacion
