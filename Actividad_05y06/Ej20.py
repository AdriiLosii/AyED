...
Programa: Ej20.py
Propósito:
    Dada la siguiente red, encontrar una ordenación topológica, explicando el proceso paso a paso.
Fecha: 13/05/2022
"""


from Class_Grafos_20 import *
import os
...
def draw(grafo, name=None, arrows=True, mapon=None, edge_route=None, label_color = "black"):
        ...
        nx.draw_networkx_nodes(G, pos, node_color=range(1,8), edgecolors="black", cmap=plt.cm.Blues)
